...
const TARGET_NETWORK_ID_STRING = process.env.REACT_APP_NETWORK_ID || "11155111"; // Default to Sepolia ID
const TARGET_NETWORK_NAME = process.env.REACT_APP_NETWORK_NAME || "Sepolia"; // Default to Sepolia Name
