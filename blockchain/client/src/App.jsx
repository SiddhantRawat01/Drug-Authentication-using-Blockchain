    ...
    return (
        <div className="App">
            ...
            <footer className="app-footer">
                <p>Network: {process.env.REACT_APP_NETWORK_NAME || 'Unknown'} (ID: {process.env.REACT_APP_NETWORK_ID || 'N/A'})</p>
                <p>Contract Address: {process.env.REACT_APP_CONTRACT_ADDRESS || "NOT SET"}</p>
            </footer>
        </div>
    );
}
